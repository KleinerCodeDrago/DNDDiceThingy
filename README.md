...
2. If you're developing on Windows, make sure you have Visual Studio installed with the "Desktop development with C++" workload enabled. This is required for building Windows applications with Flutter.
3. Clone the repository or download the source code.
4. Open the project in your preferred IDE or text editor.
5. Run the application using the following command in the terminal:```
    flutter run
...
- [(1) releases](https://github.com/your-username/your-repo/releases)
- [(2) Choose your development platform to get started](https://flutter.dev/docs/get-started/install)
- [(3) The MIT License](https://opensource.org/licenses/MIT)

update my readme accordingly and write a issue

## Pro answer

Here's the updated README with the information about the Visual C++ Redistributable being required for running the Windows release:
